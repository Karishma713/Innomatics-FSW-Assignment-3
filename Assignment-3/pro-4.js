...
(async function () {
    let density = await getUserInput("Enter traffic density (Heavy Traffic, Moderate Traffic, Light Traffic): ");
    console.log(`Green signal will stay on for: ${trafficLightControl(density)} seconds.`);
    readline.close();
})();
