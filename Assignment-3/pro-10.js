function calculateFlightFare(classType, luggageWeight, isStudent, isSenior) {
    ...
    // Add charges for excess luggage (over 20kg)
    if (luggageWeight > 20) {
    ...
    // Apply discounts based on student or senior status
    if (isStudent) {
    ...
    return `The final flight fare is: $${totalFare.toFixed(2)}`;
}
...
(async function () {
    let classType = await getUserInput("Enter the class type (Business/First): ");
